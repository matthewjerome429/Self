...
public class BaggageAllowanceBuildServiceImplByBtuByEcommTest {
	...
	public void retrieveBaggageAllowanceInfo() throws Exception {
		...
		Booking booking = mock(oneARloc("AAA000"), 
			...
			segments(
				mock(SegmentMocker.segmentID("1"), SegmentMocker.cabinClass("J"),
					port("OG1", "DS1"), marketing("FL1", "500"),
		...
		ProductsResponseDTO ecommProductsResponse = mock( 
			products(
				mock(productType(ProductTypeEnum.BAGGAGE_COMMON), sellOnOffline(false),
					segmentIds("1"),
					passengerId("1"),
					productValues(
	...
	public void populateBaggageAllowance() throws Exception {
		...
		baggageAllowanceInfo.setBaggageEcommProducts(ecommProductsResponse.getProducts());
