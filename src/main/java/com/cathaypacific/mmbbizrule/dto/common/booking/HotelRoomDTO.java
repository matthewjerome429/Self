...
public class HotelRoomDTO implements Serializable{
	...
	private static final long serialVersionUID = -2970846727440252504L;
	...
	private List<HotelRoomOptionDTO> roomOptions;
	...
	public List<HotelRoomOptionDTO> getRoomOptions() {
		return roomOptions;
	}

	public void setRoomOptions(List<HotelRoomOptionDTO> roomOptions) {
