...
public class AddSkRequestDTO {
	...
	private List<AddSkDetail> addSkDetails;
	...
	public List<AddSkDetail> getAddSkDetails() {
		return addSkDetails;
	}

	public void setAddSkDetails(List<AddSkDetail> addSkDetails) {
		this.addSkDetails = addSkDetails;
	}
