...
public class UpdateTravelDocDTOV2 extends Updated {
	...
	public boolean isBlank(){
		return  StringUtils.isEmpty(travelDocumentType) &&
				StringUtils.isEmpty(travelDocumentNumber) &&
				StringUtils.isEmpty(countryOfIssuance);
	}
}
